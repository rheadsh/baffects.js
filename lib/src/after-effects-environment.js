 ...
 * @cat AfterEffects
 * @method getAllComps
 * @return {Array} 0-based array with CompItem object for eacho one of all the compositions found in the project
 */
 ...
 * @method getCenter
 * @returns {Array} Composition's center as [x, y] array
 */
 ...
 * @return {Properties|Array} Return Properties or if the layer has effects it returns a 0-based array of [Transform Properties, FX Properties];
 */
 ...
 * @return {Array<Properties>} 0-based array of Properties object with attributes [layer, anchor, position, scale, rotation, orientation, rotationx, rotationy, rotationz, opacity].
 ...
 * @return {Properties} Properties object with all animatable properties. Attribute names are built without spaces and all lower case. (Ej. "fx.color" To get the property "Effects/Fill/Color").
 */
 ...
 * @return {Properties} Properties object with attributes [name, value]
 */
 ...
 * @return {Object} Object hierarchy containing all properties of each effect. For every effect it returns an object with attributes names without spaces and lower case. (Ej. "fx.fill.color" To get the property "Effects/Fill/Color").
 * @example 
 * <div>
 * <code>
 ...
 * @return {Array<Properties>} 0-based array of Properties object of only selected layers with attributes [layer, anchor, position, scale, rotation, orientation, rotationx, rotationy, rotationz, opacity].
 *                             Each attribute is a Property object for convenience in animation, except of layer which is the layer reference.
 */
 ...
 * @return {Properties} Array with transform Properties 
 */
...
/**
 * Reposition anchor point to bounding box option: <br>
 * 1-------2-------3    <br>
 * 4-------5-------6    <br>
 * 7-------8-------9    <br>
 * @cat AfterEffects
 ...
 * @return {Properties} Properties object with attributes [left, right, both].
 */
 ...
 * @return {Properties} Properties object with attributes [layer, anchorpoint, position, xposition, yposition, zposition, scale, orientation, xrotation, yrotation, zrotation, rotation, opacity, fill, stroke, weight].
...
/**
 * Set anchor point to bounding box option mode: <br>
 * 1-------2-------3    <br>
 * 4-------5-------6    <br>
 * 7-------8-------9    <br> 
